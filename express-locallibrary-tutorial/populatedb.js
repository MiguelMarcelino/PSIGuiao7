...
function readerCreate(nome, numero_telefone, books, cb) {
  var reader = new Reader({ nome: nome, numero_telefone: numero_telefone, books: books });
...
function createReaders(cb) {
  async.parallel([
    function (callback) {
      readerCreate('Roger Hodgson', '123456789', [bookinstances[0], bookinstances[1]], callback)
    },
    function (callback) {
      readerCreate('Rick Davies', '234567890', [bookinstances[1], bookinstances[3]], callback)
    },
    function (callback) {
      readerCreate('Cliff Hugo', '126372847', [bookinstances[2], bookinstances[1]], callback)
    },
    function (callback) {
      readerCreate('Jesse Siebenber', '372847293', [bookinstances[0], bookinstances[2]], callback)
    },
    function (callback) {
      readerCreate('Bob Siebenberg', '482637192', [bookinstances[2], bookinstances[3]], callback)
    },
    function (callback) {
      readerCreate('Mark Hart', '763826731', [bookinstances[0], bookinstances[3]], callback)
    },
